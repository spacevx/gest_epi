...
export interface Control {
    ...
    statut_id: number;
    created_at?: Date;
    gestionnaire?: Manager; // Pour les jointures
    epi?: Epi; // Pour les jointures
    statut?: ControlStatus; // Pour les jointures
}
...
export class ControlModel {
    public static async getAll(): Promise<Control[]> {
        ...
        // Transformer les résultats pour inclure les objets liés
